...
export const metadata = {
  ...
  description: "Welcome to DentalEase, your trusted partner in dental care.",
};
...
export default function Home() {
  return (
    <>
      ...
      <section className="relative h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100">
        ...
        <div className="relative z-10 text-center max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl md:text-2xl text-gray-700 mb-8 max-w-3xl mx-auto">
            Experience exceptional dental care with state-of-the-art technology
            and a team dedicated to your oral health and comfort.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Comprehensive dental care services tailored to meet your needs
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-50 rounded-lg p-8 hover:shadow-lg transition-shadow duration-200">
              ...
              <p className="text-gray-600">
                Transform your smile with whitening, veneers, and other cosmetic
                procedures.
              </p>
            </div>
            <div className="bg-gray-50 rounded-lg p-8 hover:shadow-lg transition-shadow duration-200">
              ...
              <p className="text-gray-600">
                Straighten your teeth with braces, Invisalign, and other
            ...
            <div className="bg-gray-50 rounded-lg p-8 hover:shadow-lg transition-shadow duration-200">
              ...
              <p className="text-gray-600">
                24/7 emergency dental care for urgent dental problems and pain
                relief.
              </p>
            </div>
            <div className="bg-gray-50 rounded-lg p-8 hover:shadow-lg transition-shadow duration-200">
              ...
              <p className="text-gray-600">
                Advanced surgical procedures including wisdom teeth removal and
                dental implants.
              </p>
            </div>
            <div className="bg-gray-50 rounded-lg p-8 hover:shadow-lg transition-shadow duration-200">
              ...
              <p className="text-gray-600">
                Specialized dental care for children in a friendly and
      ...
      <section id="clinic" className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6">
                At DentalEase, we believe in providing exceptional dental care
                with a focus on patient comfort and advanced technology. Our
                experienced team of dental professionals is committed to
                creating a welcoming environment where every patient feels
      ...
      <section id="appointments" className="py-20 bg-blue-600">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              Get in touch with us for any questions or to schedule your
              appointment
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">info@dentalease.com</p>
            </div>
          </div>
        </div>
      </section>
