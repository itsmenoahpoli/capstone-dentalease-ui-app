        ...
        <section className="relative h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100">
          ...
          <div className="relative z-10 text-center max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-xl md:text-2xl text-gray-700 mb-8 max-w-3xl mx-auto">
              Experience exceptional dental care with state-of-the-art
              technology and a team dedicated to your oral health and comfort.
            </p>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-gray-50 rounded-lg p-8 hover:shadow-lg transition-shadow duration-200">
                ...
                <p className="text-gray-600">
                  Transform your smile with whitening, veneers, and other
                  cosmetic procedures.
                </p>
              </div>
              <div className="bg-gray-50 rounded-lg p-8 hover:shadow-lg transition-shadow duration-200">
              ...
              <div className="bg-gray-50 rounded-lg p-8 hover:shadow-lg transition-shadow duration-200">
                ...
                <p className="text-gray-600">
                  Advanced surgical procedures including wisdom teeth removal
                  and dental implants.
                </p>
              </div>
              <div className="bg-gray-50 rounded-lg p-8 hover:shadow-lg transition-shadow duration-200">
